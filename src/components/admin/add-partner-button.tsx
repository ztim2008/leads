    ...
    <tr><td colSpan={8} style={{padding:"16px 20px"}}>
      <form onSubmit={handleSubmit}>
        ...
        <div style={block}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            <div><label style={lbl}>Chat ID (от @getmyid_bot)</label><input name="telegramChatId" style={i} placeholder="778784292"/></div>
            <div><label style={lbl}>Bot Token (от @BotFather)</label><input name="telegramToken" style={i} placeholder="123456:ABC-DEF..."/></div>
          </div>
        </div>
