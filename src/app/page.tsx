...
const FEATURES = [
  { icon: Search, title: "Автоматический мониторинг", desc: "Система сама отслеживает новые заказы на Profi.ru, Авито, FL.ru и Kwork. Вам не нужно открывать десятки площадок вручную." },
...
const STEPS = [
  { num: "01", title: "Подключите площадки", desc: "Выберите источники: Profi.ru, Авито, FL.ru, Kwork. Настройте ключевые слова под специализацию." },
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <p style={{
              ...
              Konversus Leads AI мониторит Profi.ru, Авито, FL.ru и Kwork,
              анализирует заявки через ИИ и присылает только подходящие в Telegram.
            </p>
