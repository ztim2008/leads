  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--ink-muted)", fontSize: "var(--text-sm)", marginBottom: 24, maxWidth: 520 }}>
        Создать идею может только админ. После создания агент разложит идею на за/против, риски и шаги.
        Партнёры с доступом увидят её на доске и смогут комментировать.
      </p>
      <div
        style={{
